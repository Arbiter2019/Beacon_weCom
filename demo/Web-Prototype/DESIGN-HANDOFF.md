# c21aadb1-9c44-4b69-969b-f2b4e0407922 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `消息存档/index.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `消息存档/index.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `消息存档/index.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `message-archive-prototype.html`
- `消息存档/index.html`
...
## Scripts/components
- `checks/composer-end-marker-check.mjs`
- `checks/drawer-regression-check.mjs`

## Assets and supporting files
- `critique.json`
- `mremp3m9-截屏2026-07-10-15.41.13.png`
- `mrer8qw6-截屏2026-07-10-17.49.40.png`

## Coding checklist for AI tools
1. Inspect `消息存档/index.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
